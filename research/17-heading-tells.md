...
**The title repeated as the first heading.** A document titled "Deployment guide" opening with an H1 that says "Deployment guide".

**Skipped levels.** H2 straight to H4. Breaks screen reader navigation as well as looking generated.

**Level 1 used for minor subsections.** Maximum-size headings on small units.

**"X and Y" headings.** "Challenges and opportunities", "Awards and recognition", "Benefits and limitations", "Tools and technologies". The paired-noun heading is close to universal in AI-written articles.
